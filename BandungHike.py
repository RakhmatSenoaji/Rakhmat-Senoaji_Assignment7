...
def load_data():
    points = gpd.read_file("data/points_final.geojson", engine="pyogrio").to_crs(epsg=4326)
    lines = gpd.read_file("data/trails_final.geojson", engine="pyogrio").to_crs(epsg=4326)
    stasiun = gpd.read_file("data/stasiun_final.geojson", engine="pyogrio").to_crs(epsg=4326)
